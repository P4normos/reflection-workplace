package org.workplace.fields_and_arrays.jsonwriter;

import org.workplace.fields_and_arrays.jsonwriter.data.*;
...
public class Main {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        Company company = new Company("Panormos","İstanbul",new Address("İstiklal",(short)600));
        Address address = new Address("Main street",(short)1);
        Person person = new Person("John",true,29,100.555f, address, company);

        String json1 = objectToJson(address, 0);
        String json2 = objectToJson(person, 0);
        ...
        Movie movie1 = new Movie("Lord of the Rings",8.8f,
                new String[]{"Action","Adventure","Drama"}, new Actor[]{actor1,actor2, actor3});

        String json3 = objectToJson(actor1,0);
        String json4 = objectToJson(movie1,0);
