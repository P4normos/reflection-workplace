package org.workplace.fields_and_arrays.configloader;

import org.workplace.fields_and_arrays.configloader.data.GameConfig;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        UserInterfaceConfig userInterfaceConfig = createConfigObject(UserInterfaceConfig.class, USER_INTERFACE_CONFIG_PATH);
