package org.workplace.fields_and_arrays.fields_init;
...
public class Main {
    ...
    public static void main(String[] args) throws IllegalAccessException, NoSuchFieldException {
        ...
        printDeclaredFieldsInfoWithFieldValues(movie.getClass(), movie);
    ...
    public static <T> void printDeclaredFieldsInfoWithFieldValues(Class<? extends T> clazz, T instance) throws IllegalAccessException {
        for(Field field : clazz.getDeclaredFields()){
            System.out.println(String.format("Field name %s type %s",
                    field.getName(),
                    field.getType().getName()));
