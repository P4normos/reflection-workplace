package org.workplace.proxy;

import org.workplace.proxy.external.DatabaseReader;
import org.workplace.proxy.external.HttpClient;
import org.workplace.proxy.external.impl.DatabaseReaderImpl;
import org.workplace.proxy.external.impl.HttpClientImpl;
...
//        listOfGreetings.remove("hello");
    ...
    public static class TimeMeasuringProxyHandler implements InvocationHandler{
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            System.out.println();
            System.out.println(String.format("Measuring Proxy - Executing of %s() took %sns",
                    method.getName(),
                    endTime-startTime));
